...
describe("html plugin", function () {
  ...
  it("should parse color, background, font-weight and text-decoration", function () {
    compare('A<span style="color:red;background:white;font-weight:bold;text-decoration:underline">B</span>C', "A{red-fg}{white-bg}{bold}{underline}B{/underline}{/bold}{/white-bg}{/red-fg}C");
  });

  it("should support nested styles", function () {
    compare('A<span style="color:red">B<span style="font-weight:bold">C</span>D</span>E', "A{red-fg}B{bold}C{/bold}D{/red-fg}E");
  });

  it("should close nested tags if the parent is closed first", function () {
    compare('A<div style="color:red">B<span style="font-weight:bold">C</div>D', "A{red-fg}B{bold}C{/bold}{/red-fg}D");
  });
  ...
  it("should parse result line", function () {
    compare('A<div style="color:red">B<span style="font-weight:bold">C</div>D', "A{red-fg}B{bold}C{/bold}{/red-fg}D", "result");
  });
});
